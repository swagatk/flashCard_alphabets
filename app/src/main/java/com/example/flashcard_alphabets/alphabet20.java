...
public class alphabet20 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alphabetData [] myAlphabetData = new alphabetData[]{
                new alphabetData("Table", R.drawable.table),
                new alphabetData("Tent", R.drawable.tent),
                new alphabetData("Tomato", R.drawable.tomato),
        };

        MyAlphabetAdapter myAlphabetAdapter = new MyAlphabetAdapter(myAlphabetData, alphabet20.this);
        ...
        fabFwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(alphabet20.this, alphabet21.class));
            }
        });
        ...
        fabBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet20.this, AlphaHome.class));
            }
        });
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet20.this, Dashboard.class));
            }
        });
    }
}
