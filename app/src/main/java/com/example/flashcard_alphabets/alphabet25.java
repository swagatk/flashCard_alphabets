...
public class alphabet25 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alphabetData [] myAlphabetData = new alphabetData[]{
                new alphabetData("Yacht", R.drawable.yacht),
                new alphabetData("Yak", R.drawable.yak),
                new alphabetData("Yo-Yo", R.drawable.yoyo),
        };

        MyAlphabetAdapter myAlphabetAdapter = new MyAlphabetAdapter(myAlphabetData, alphabet25.this);
        ...
        fabFwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(alphabet25.this, alphabet26.class));
            }
        });
        ...
        fabBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet25.this, AlphaHome.class));
            }
        });
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet25.this, Dashboard.class));
            }
        });
    }
}
