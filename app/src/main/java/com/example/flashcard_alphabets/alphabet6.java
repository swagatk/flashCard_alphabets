...
public class alphabet6 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alphabetData [] myAlphabetData = new alphabetData[]{
                new alphabetData("Fan", R.drawable.fan),
                new alphabetData("Fish", R.drawable.fish),
                new alphabetData("Frog", R.drawable.frog),
        };

        MyAlphabetAdapter myAlphabetAdapter = new MyAlphabetAdapter(myAlphabetData, alphabet6.this);
        ...
        fabFwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(alphabet6.this, alphabet7.class));
            }
        });
        ...
        fabBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet6.this, AlphaHome.class));
            }
        });
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet6.this, Dashboard.class));
            }
        });
    }
}
