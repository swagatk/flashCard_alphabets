...
public class alphabet9 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alphabetData [] myAlphabetData = new alphabetData[]{
                new alphabetData("Icecream", R.drawable.icecream),
                new alphabetData("Igloo", R.drawable.igloo),
                new alphabetData("Island", R.drawable.island),
        };

        MyAlphabetAdapter myAlphabetAdapter = new MyAlphabetAdapter(myAlphabetData, alphabet9.this);
        ...
        fabFwd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(alphabet9.this, alphabet10.class));
            }
        });
        ...
        fabBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet9.this, AlphaHome.class));
            }
        });
        ...
        fabHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(alphabet9.this, Dashboard.class));
            }
        });
    }
}
